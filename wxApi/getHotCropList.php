...
$sql = "select a.*,b.varietyname category_1,c.varietyname category_2,
 ...
 ,(select COUNT(*) from AppCropCommentRecord WHERE CommentCropId=a.CropId) Comment from WXCrop a
...
where a.Flag=0  and (select COUNT(*) from AppCropCommentRecord WHERE CommentCropId=a.CropId)!=0 
...
echo app_wx_iconv_result('getHotCropList', true, 'success', 0, 0, 0, $array);
?>