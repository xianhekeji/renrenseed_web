...
class Common_util_pub {
     ...
     * @return
     */
    public function sendliebianhongbaoto($arr) {
        $data['nonce_str'] = self::createNoncestr();
        $data['mch_billno'] = '1489683862' . date("Ymd", time()) . date("His", time()) . rand(1111, 9999);
        $data['mch_id'] = '1489683862';
        $data['wxappid'] = 'wx3b7ff48efe8b5670';
...
//$comm = new Common_util_pub();
    ...
    public function getSign($Obj) {
        ...
        //签名步骤二：在string后加入KEY
        $String = $String . "&key=" . "11b9d231af6eb529ec969ed722b8c4d4"; // 商户后台设置的key
